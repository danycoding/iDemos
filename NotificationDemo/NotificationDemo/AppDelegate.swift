...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, handleActionWithIdentifier identifier: String?, forLocalNotification notification: UILocalNotification, completionHandler: () -> Void) {
        ...
        if identifier == "ACTIONABLE" {
            NSNotificationCenter.defaultCenter().postNotificationName("ACTIONABLE", object: nil)
        }
        else if identifier == "ACTION_ONE" {
            NSNotificationCenter.defaultCenter().postNotificationName("ACTION_ONE", object: nil)
        }
        else if identifier == "ACTION_TWO" {
